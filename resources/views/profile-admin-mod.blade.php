	...
	<body>
		...
		<section id="profil-navbar">
			...
			<ul class="nav nav-pills justify-content-center">
					<li class="nav-item">
						<a class="nav-link" href="/profile-admin-main">Profil</a>
					</li>
					<li class="nav-item">
					...
					<table class="table table-striped table-sm">
					  ...
					  <tbody>
						<tr>
						  ...
						  <td><img src="{{URL('/images/forum/personal-finance.png')}}" width="25%" alt=""></td>
						  <td>
						...
						<tr>
							...
							<td><img src="{{URL('/images/forum/team_pag.png')}}" width="25%" alt=""></td>
							<td>
								<i class="fas fa-pen"></i>
								<i class="fas fa-search"></i>
								<i class="fas fa-times"></i>
